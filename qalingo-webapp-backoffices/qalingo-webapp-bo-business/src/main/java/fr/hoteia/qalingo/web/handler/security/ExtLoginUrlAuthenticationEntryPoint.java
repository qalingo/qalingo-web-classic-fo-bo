...
public class ExtLoginUrlAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint {
	...
	protected String determineUrlToUseForThisRequest(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			String url = boBusinessUrlService.buildLoginUrl(request);
			return url;
		} catch (Exception e) {
			LOG.error("", e);
		}
	...
	public void setBoBusinessUrlService(BoBusinessUrlService boBusinessUrlService) {
		this.boBusinessUrlService = boBusinessUrlService;
	}
