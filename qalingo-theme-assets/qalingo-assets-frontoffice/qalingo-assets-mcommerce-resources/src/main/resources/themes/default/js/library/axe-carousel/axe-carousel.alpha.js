...
(function ($) {
    ...
    $.fn.axeCarousel = function (options) {
        ...
        return this.each(function () {
            ...
            ac_html += "<div class='axe-carousel' style='overflow: hidden; position: relative; width: " + carousel_outer_width + "px; height: " + carousel_outer_height + "px;'>";
            ...
            var axe_carousel = obj.find(".axe-carousel");
            ...
            if (number_slides_visible > 1) {
                ...
                axe_carousel.css("width", number_slides_visible * slide_width + "px");
            ...
            var axe_carousel_buttons_click = obj.find(".ac_click");
            var axe_carousel_buttons_hover = obj.find(".ac_hover");
			...
			////////////////
			 ...
			 $(axe_carousel_buttons_click).click(function(){
				 pause_slideshow();
			...
			$(axe_carousel_buttons_hover).hover(function() {
				pause_slideshow();
    			if(ac_slides_container.find(':animated').length < 1){
					transition_slides($(this).data().options);
